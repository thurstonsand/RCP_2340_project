...
<html>
	<head>
		...
		<title>edit ${seedInstance.name}</title>
	</head>
	<body>
		<a href="#edit-seed" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
